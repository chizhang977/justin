...
- [**css-loaders**](https://css-loaders.com/)  CSS 实现的各种动画加载效果，代码简洁
...
## Vue<Badge type="warning" text="new" />

- [**Element UI**](https://element.eleme.cn/#/zh-CN/component/installation): 一套为开发者、设计师和产品经理准备的基于Vue 2.0的桌面端组件库。
- [**Element Plus**](https://element-plus.org/zh-CN/):基于 Vue 3，面向设计师和开发者的组件库
- [**Quasar Framework**](https://quasar.dev/): 一个功能强大的Vue框架，提供丰富的组件和功能，可以构建高性能、跨平台的应用。
- [**Ant Design Vue**](https://www.antdv.com/): Ant Design的Vue实现，提供高质量的UI组件。

- [**Vuelidate**](https://github.com/vuelidate/vuelidate): 简单、轻量级的Vue**表单验证库**。

- [**ECharts for Vue**](https://github.com/ecomfe/vue-echarts): ECharts的Vue封装，用于数据可视化。
- [**Vue Chart.js**](https://vue-chartjs.org/): 基于Chart.js的Vue组件，用于绘制图表。

- [**Pinia**](https://pinia.vuejs.org/): Vue的**轻量级状态管理库**，是Vuex的替代品，设计更简单直观。

- [**Tiptap**](https://tiptap.dev/): 一个基于ProseMirror的富文本编辑器，具有高度可定制性，适用于Vue。

- [**Vue FilePond**](https://gitcode.com/pqina/vue-filepond/overview?utm_source=artical_gitcode&isLogin=1): Vue的文件上传组件，提供现代的文件上传功能。

- [**Vue Cropper**](https://github.com/xyxiao001/vue-cropper): 一个图片裁剪组件，功能强大且易于使用。
...
## 文档 <Badge type="warning" text="new" />
- [**vitepress**](https://vitepress.dev/zh/) 由Vite驱动的VuePress的下一个迭代，适用于文档网站，速度真的很快
- [**vuepress**](https://github.com/vuejs/vuepress) 一个以Vue驱动的静态网站生成器，适合技术文档的编写
- [**docsify**](https://github.com/docsifyjs/docsify) 轻量级文档工具，但其是运行时编译的，所以 seo 不好
- [**GitBook**](https://www.gitbook.com/) 一个现代化的文档平台，允许团队创建、编辑和维护文档。它支持Markdown格式，并提供强大的版本控制和协作功能。尽管编译速度可能较慢，但其功能强大且界面友好，使其成为技术文档和知识库的优秀选择，专注于**商业产品而不是开源工具**。
- [**mdx**](https://github.com/mdx-js/mdx) jsx + markdown
- [**docz**](https://github.com/pedronauck/docz) 基于MDX构建，旨在为React组件创建文档。它可以帮助你快速生成文档，并提供实时编辑和预览功能，非常适合构建和维护React组件库的文档。
- [**storybook**](https://github.com/storybooks/storybook) 个用于开发和展示UI组件的工具，支持React、Vue、Angular等多个框架。它允许你在独立环境中开发组件，并为每个组件编写故事（Story），便于测试和展示。Storybook不仅适用于文档，还能作为组件开发和测试工具。
